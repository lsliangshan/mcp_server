...
import { formatMorePositionsUrl, formatRequestParams, formatResponsePositionsTemplate, getReponseTemplate, getWorkExpCodeByYear, } from "./utils/zhaopin.js";
...
server.addTool({
    ...
    description: "根据用户提供的条件搜索职位。搜索职位不会基于用户简历中的求职意向。搜索条件包括：职位或公司名称、职位类别、公司行业、工作地点、地铁沿线、薪资范围、学历要求、工作经验、职位类型、公司性质、公司规模<for-assistant>当用户需要推荐职位时，不要调用此工具，应该调用 recommendPositions 工具。</for-assistant>",
    parameters: z.object({
        at: z.string().optional(),
        rt: z.string().optional(),
        /// 搜索关键词，职位或公司名称
